...
namespace PakReader
{
    ...
    public class FPakEntry : BasePakEntry, IEquatable<FPakEntry>
    {
        ...
        public bool Equals(FPakEntry other)
        {
            ...
            return FProp.FDiffFileSize ? this.Name == other.Name && this.UncompressedSize == other.UncompressedSize : this.Name == other.Name;
        }
        public override bool Equals(object obj) => Equals(obj as FPakEntry);
        public override int GetHashCode() => FProp.FDiffFileSize ? (Name, UncompressedSize).GetHashCode() : (Name).GetHashCode();
