...
namespace FModel.Methods.Auth
{
    static class AuthFlow
    {
        ...
        public static void SetOAuthLauncherToken()
        {
            ...
            Settings.ELauncherToken = launcher_access_token;
          Settings.ELauncherExpiration = DateTimeOffset.Now.AddSeconds(Convert.ToDouble(launcher_expires_in)).ToUnixTimeMilliseconds();
        ...
        public static bool IsLauncherTokenExpired()
        {
            ...
            if ((currentTime - 60000) >= Settings.ELauncherExpiration)
            {
                return true;
            }
            return false;
