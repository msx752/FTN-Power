...
namespace FModel.Methods
{
    ...
    static class PAKEntries
    {
        ...
        public static Dictionary<string, PakReader.FPakEntry[]> PAKToDisplay { get; set; }
    }
    ...
    static class AssetEntries
    {
        ...
        public static Dictionary<string, PakReader.FPakEntry[]> ArraySearcher { get; set; } //because smh searching through a dictionary is faster than through an array
    }
    #endregion
